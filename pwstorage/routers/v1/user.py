...
@router.post("/", openapi_extra=exc_list(UserEmailAlreadyExistsException))
...
@router.put("/me", openapi_extra=exc_list(UserEmailAlreadyExistsException))
...
@router.patch("/me", openapi_extra=exc_list(UserEmailAlreadyExistsException))
